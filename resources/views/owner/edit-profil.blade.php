            ...
            <form action="{{ url('/owner/edit-profil') }}" method="post" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error('JENIS_KELAMIN') is-invalid @enderror" onclick="return false;" type="radio" name="JENIS_KELAMIN" id="jk_pria" value="1" required @if($data->JENIS_KELAMIN_OWNER == 1) checked @endif >
                        <label class="form-check-label" for="jk_pria">Pria</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input @error('JENIS_KELAMIN') is-invalid @enderror" onclick="return false;" type="radio" name="JENIS_KELAMIN" id="jk_wanita" value="0" required @if($data->JENIS_KELAMIN_OWNER == 0) checked @endif >
                ...
                <div class="form-group">
                    ...
                    <input type="text" min="0"  class="form-control num-without-style @error('NO_TELP') is-invalid @enderror" name="NO_TELP" value="{{ $data->NO_TELP_OWNER }}" required>
                    <div class="invalid-feedback">
